...
if(isset($_POST['blumen']))
  {
    ...
    $jsonObj= json_decode($_POST['blumen']);
       ...
       $habitus= $jsonObj->habitus;
       $nomos=$jsonObj->nomos;
       $anmFundpunkt= $jsonObj->anmFundpunkt;
       $ungenauigkeit=$jsonObj->ungenauigkeit;
       $spinner=$jsonObj->spinner;
       $spinner2=$jsonObj->spinner2;
       $anmDatum= $jsonObj->anmDatum;
       $year= $jsonObj->year;
       $month=$jsonObj->month; 
       $day=$jsonObj->day;
       $fp_datevon="$year-$month-$day";
       $year2=$jsonObj->year2;
       $month2=$jsonObj->month2;
       $day2= $jsonObj->day2; 
       $fp_datebis="$year2-$month2-$day2";
          
       //Herbar
       $herbarNr= $jsonObj->herbarNr; 
       $anmHerbar= $jsonObj->anmHerbar;
       
       
       //Eintrag
       $taxonAnm= $jsonObj->taxonAnm;
       $link= $jsonObj->link;
       $lit=$jsonObj->lit;
       $paldat=$jsonObj->paldat;
       $foto=$jsonObj->foto;
       $fotoDig=$jsonObj->fotoDig;
       $habitat= $jsonObj->habitat;
       $herbarium= $jsonObj->herbarium;
       //Status
       $typ=$jsonObj->typ;
      ...
      //Beobachtet
      $beobacht= $jsonObj->beobacht;
      
      //Überprüft
      $prvtVon=$jsonObj->prvtVon; 
      
      //herbariumeintrag
      $sammelNr=$jsonObj->sammelNr;
      
      //Literatureintrag
      $werk=$jsonObj->werk;
      $seiten=$jsonObj->seiten;
      $litherbar=$jsonObj->litherbar;
      $taxonGenannt=$jsonObj->taxonGenannt; 
